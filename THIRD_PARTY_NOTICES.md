...
The teacher-provided curriculum packets are reference material only and are not redistributed in this repository. Assembly transforms, scene, game rules, and lesson text are new work. The part geometry is not a claim of certified assembly accuracy. See the teacher guide's physical checks.
